...
Calculating collapse values for all code species. 
...
#calculate cumulative number of stocks collapsed (ie show number of collapsed stocks by 1960, instead of number of stocks collapsed in each year)
...
all_species_prop
  #ggplot(aes(tsyear, percent_collapse))+ geom_line()+scale_y_reverse()
ggplot(all_species_prop, aes(x=tsyear))+
  geom_line(aes(y=percent_collapse), col="red")+
  geom_line(aes(y=percent_collapse_cum), col="blue")+
