...
legend("topright", legend=c("Percent Collapsed", "Cumulative Percent Collapse"))


all_species_prop
#make a legend (assign category variables to each type, plot data based on category type, different colors)
#try to pivot longer 
```
